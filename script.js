...
let principal = document.getElementByld("principal").value;

// variable called "rate" and assigning it the value of the input element having id of "rate" 
let rate = document.getElementByld("rate").value;

// variable called "years" and assigning it the value of the input element having id of"years" 
let years = document.getElementByld("years").value;

// variable called "interest" and assigning it the value of principal * years * rate / 100 
let interest = principal * years * rate / 100

// Convert number of year into actual year in future (ie, from now on) by using Date() 
constructor let futureYearFromNow = new Date(); 
...
document.getElementByld("result").innerHTML = kb>S{interest}</b> to be paid by year S{futureYearFromNow.
...
document.getElementByld("rangeOutput").innerHTML = "${rangeslidervalue}"
}
